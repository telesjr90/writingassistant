...
- Latest completed parent is `PHASE8-IMPL-012 - Writer Assistant Core review queue storage and owner-review workflow planning`, complete through `PHASE8-IMPL-012-T007 - Roadmap/status closeout`. The current active parent is `PHASE8-IMPL-013 - Writer Assistant Core review UI/API planning and owner-action workflow contract` (active after `PHASE8-IMPL-013-T004`, docs/decision only). `PHASE8-IMPL-013-T002` accepted the read-only review queue API contract, `PHASE8-IMPL-013-T003` accepted the owner action command API contract, and `PHASE8-IMPL-013-T004` accepted the review UI planning boundary at `docs/roadmap/decisions/PHASE8-IMPL-013-review-ui-planning-boundary-decision.md`. The T004 contract requires future UI to display evidence/provenance/source locators, confidence as uncertainty/support strength, insufficient-evidence and rejected-output states, no-promotion/no-canon warnings, accessible empty/error/quarantine states, and owner-action controls as planning terms only. `PHASE8-IMPL-013-T005` is ready/active; T006-T007 are planned. No review UI/API, backend routes, frontend UI, frontend API helpers, owner action execution, apply-promotion, memory/canon mutation, runtime extraction, raw artifact persistence, generated prose, package changes, model calls, tests, or training/JSONL/dataset work is implemented or claimed.
