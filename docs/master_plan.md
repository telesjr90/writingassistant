...
- Latest completed frontier parent is `PHASE8-IMPL-004 - Writer Assistant Core candidate index contract and derived index helpers`; it is complete through `PHASE8-IMPL-004-T007 - Roadmap/status closeout`. Active frontier parent is `PHASE8-IMPL-005 - Writer Assistant Core tool evaluation and extraction strategy decision`; it is active through `PHASE8-IMPL-005-T003 - Official source inventory and license/dependency screen`. Prior completed child under active parent: `PHASE8-IMPL-005-T002 - Evaluation scope, fixture plan, and scoring rubric decision`. Active child: `PHASE8-IMPL-005-T004 - Dramatica-flow analysis-only reference decision`.
