...
- Latest completed frontier parent is `PHASE8-IMPL-007 - Writer Assistant Core BookNLP adapter contract implementation and mocked normalization foundation`; it is complete through `PHASE8-IMPL-007-T007 - Roadmap/status closeout`. Latest active parent is `PHASE8-IMPL-008 - Writer Assistant Core raw extraction artifact storage and BookNLP fixture parser contract`; it is active as of `PHASE8-IMPL-008-T001 - Publish raw extraction artifact storage and BookNLP fixture parser contract parent` (docs/status/planning only). The active child is `PHASE8-IMPL-008-T002 - Raw extraction artifact storage contract decision` (ready/active); `PHASE8-IMPL-008-T003` through `PHASE8-IMPL-008-T007` are planned/draft. No raw extraction artifact storage helpers or files exist yet, no BookNLP fixture parser exists yet, no real BookNLP/spaCy install or execution exists, no runtime extraction, no routes, no UI, no package changes, no generated prose, no apply-promotion, and no memory/canon mutation exists. Recommended next parent is `PHASE8-IMPL-009 - Writer Assistant Core BookNLP fixture parser helper implementation and raw artifact bundle integration`, recommended only and not active.
