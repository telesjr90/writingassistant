...
Writer Assistant Core has completed schema constants in `PHASE8-IMPL-001`, candidate record validation and storage path contract helpers in `PHASE8-IMPL-002`, candidate-only JSON write/read/list persistence helpers in `PHASE8-IMPL-003`, derived candidate index contract/helpers/safety regressions in `PHASE8-IMPL-004`, tool evaluation/extraction strategy in `PHASE8-IMPL-005`, the evidence-first extraction foundation plus BookNLP-ready adapter strategy in `PHASE8-IMPL-006`, and the mocked BookNLP adapter contract implementation and normalization foundation in `PHASE8-IMPL-007`. `PHASE8-IMPL-008` is now active as the raw extraction artifact storage and BookNLP fixture parser contract parent. `PHASE8-IMPL-008-T001` through `PHASE8-IMPL-008-T005` are complete: T002 accepted the project-local raw extraction artifact storage contract, T003 added expected-red storage contract tests, T004 created pure storage path and manifest validation helpers, and T005 accepted the in-memory BookNLP fixture parser contract decision at `docs/roadmap/decisions/PHASE8-IMPL-008-booknlp-fixture-parser-contract-decision.md`. The active child is `PHASE8-IMPL-008-T006` (tests-first BookNLP fixture parser contract tests); `PHASE8-IMPL-008-T007` is planned/draft. The future parser module is `backend/story_knowledge/booknlp_fixture_parser.py`, but it does not exist yet. No raw artifact write/read/list helpers, parser implementation, parser tests, runtime extraction, real BookNLP/spaCy install or execution, routes, UI, package changes, generated prose, apply-promotion, or memory/canon mutation exists. Parser implementation is recommended for `PHASE8-IMPL-009 - Writer Assistant Core BookNLP fixture parser helper implementation and raw artifact bundle integration`, recommended only and not active.
...
- Latest completed frontier parent is `PHASE8-IMPL-007 - Writer Assistant Core BookNLP adapter contract implementation and mocked normalization foundation`; it is complete through `PHASE8-IMPL-007-T007 - Roadmap/status closeout`. Latest active parent is `PHASE8-IMPL-008 - Writer Assistant Core raw extraction artifact storage and BookNLP fixture parser contract`; it is active with `PHASE8-IMPL-008-T001 - Publish raw extraction artifact storage and BookNLP fixture parser contract parent`, `PHASE8-IMPL-008-T002 - Raw extraction artifact storage contract decision`, `PHASE8-IMPL-008-T003 - Extraction artifact storage path and manifest contract tests`, `PHASE8-IMPL-008-T004 - Minimal extraction artifact storage helpers`, and `PHASE8-IMPL-008-T005 - BookNLP fixture parser contract decision` complete. The active child is `PHASE8-IMPL-008-T006 - BookNLP fixture parser contract tests` (tests-first expected-red); `PHASE8-IMPL-008-T007` is planned/draft. No raw extraction artifact files exist, no raw file write/read/list helpers exist, no BookNLP fixture parser exists yet, no real BookNLP/spaCy install or execution exists, no runtime extraction, no routes, no UI, no package changes, no generated prose, no apply-promotion, and no memory/canon mutation exists. Recommended next parent is `PHASE8-IMPL-009 - Writer Assistant Core BookNLP fixture parser helper implementation and raw artifact bundle integration`, recommended only and not active.
