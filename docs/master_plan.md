...
- Latest completed frontier parent is `PHASE8-IMPL-005 - Writer Assistant Core tool evaluation and extraction strategy decision`; it is complete through `PHASE8-IMPL-005-T007 - Roadmap/status closeout`. Active parent is `PHASE8-IMPL-006 - Writer Assistant Core evidence-first extraction foundation and BookNLP-ready adapter strategy`; last completed child is `PHASE8-IMPL-006-T004 - Minimal source-map/evidence helper implementation`; next child is `PHASE8-IMPL-006-T005 - BookNLP-ready raw output and adapter contract decision`.
