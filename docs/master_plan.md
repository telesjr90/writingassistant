...
- `PHASE8-UX-002-T006` - Implement Notes/Materials + runtime/review evidence UI. In progress; T006A Notes/Materials evidence UI is complete/PASS and T006B is next.
