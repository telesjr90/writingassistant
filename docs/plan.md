...
| 4 | Frontend MVP diagnostics | FE-001 rich Story Check sidebar is complete; remaining frontend hardening covers editor dirty-state, empty scene behavior, and broader save/load UX. |
