...
- Project Workspace Foundation implementation: use `docs/roadmap/project_workspace_foundation_spec.md` as the WORKSPACE-001 handoff for project creation/library, chapters/scenes/notes/materials, owner-authored document editor, project overview, OMI-guided project creation, approval workflow, approved memory/canon pages, and first usable workspace acceptance.
