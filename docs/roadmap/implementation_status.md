...
- Active child task: `PHASE8-IMPL-006-T005` - BookNLP-ready raw output and adapter contract decision.
- Next child task: `PHASE8-IMPL-006-T006` - BookNLP-ready adapter contract tests.
- Last completed child task: `PHASE8-IMPL-006-T004` - Minimal source-map/evidence helper implementation.
