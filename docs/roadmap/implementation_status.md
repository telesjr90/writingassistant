...
- Active child task: `PHASE8-IMPL-007-T004` - Manifest and raw artifact bundle validators.
- Next child task: `PHASE8-IMPL-007-T005` - Entity/quote/event mocked normalization helpers.
- Last completed child task: `PHASE8-IMPL-007-T003` - BookNLP adapter implementation decision after source inventory.
