...
- Active child task: `PHASE8-IMPL-006-T004` - Minimal source-map/evidence helper implementation.
- Next child task: `PHASE8-IMPL-006-T005` - BookNLP-ready raw output and adapter contract decision.
- Last completed child task: `PHASE8-IMPL-006-T003` - Evidence/source-map contract tests.
