...
- Immediate active parent task: `PHASE8-IMPL-009` - Writer Assistant Core BookNLP fixture parser helper implementation and raw artifact bundle integration.
- Active child task: `PHASE8-IMPL-009-T007` - Roadmap/status closeout.
- Next child task: none under `PHASE8-IMPL-009`.
- Last completed child task: `PHASE8-IMPL-009-T006` - Targeted parser contract validation and boundary hardening.
...
- Last completed parent task: `PHASE8-IMPL-008` - Writer Assistant Core raw extraction artifact storage and BookNLP fixture parser contract.
...
`PHASE8-IMPL-009` is active as the ninth Writer Assistant Core parent. `PHASE8-IMPL-009-T001` published the parent task record at `docs/roadmap/tasks/PHASE8-IMPL-009.md`, the inventory at `docs/roadmap/inventory/PHASE8-IMPL-009.md`, the enrichment JSON at `docs/roadmap/enrichment/PHASE8-IMPL-009.enrichment.json`, and the roadmap/status updates. This parent exists to implement the pure in-memory BookNLP fixture parser helper module that satisfies `tests/test_writer_assistant_core_booknlp_fixture_parser_contract.py` and builds raw artifact bundles compatible with `validate_booknlp_raw_artifact_bundle`. T001 is docs/status/planning only: it did not create `backend/story_knowledge/booknlp_fixture_parser.py`, did not modify backend code or tests, did not implement raw artifact write/read/list helpers, did not create runtime project files, did not install/import/run BookNLP or spaCy, did not run model calls or context tools, and did not stage, commit, or push. `PHASE8-IMPL-009-T002` completed the parser implementation contract reconciliation decision at `docs/roadmap/decisions/PHASE8-IMPL-009-parser-implementation-contract-reconciliation-decision.md`. T002 accepted the public parser APIs, accepted the T003-T006 split, and confirmed T003 is the first runtime parser implementation child. `PHASE8-IMPL-009-T003` created `backend/story_knowledge/booknlp_fixture_parser.py` and implemented the minimal pure in-memory TSV parsers for tokens, entities, quotes, and supersense. `PHASE8-IMPL-009-T004` implemented pure in-memory `.book` JSON parsing and token-event derivation from token `event` markers, preserving `.book.g` as raw aggregate metadata only and derived events as support only. `PHASE8-IMPL-009-T005` implemented pure in-memory raw artifact bundle builder integration in `backend/story_knowledge/booknlp_fixture_parser.py`, validating fixture input, storage manifest, source map, raw output references, derived token events, and the final adapter-compatible bundle. `PHASE8-IMPL-009-T006` completed validation and boundary hardening with the full parser contract passing, no parser hardening patch needed, and existing storage/adapter/source/evidence/candidate/OMI regressions green. `PHASE8-IMPL-009-T007` is active next as roadmap/status closeout. No parser filesystem I/O, raw artifact persistence, runtime extraction, routes, UI, package changes, real BookNLP/spaCy runtime, generated prose, apply-promotion, or memory/canon mutation exists.
...
The published Phase 7 parent sequence (`PHASE7-IMPL-001` through `PHASE7-IMPL-010`) is complete. `PHASE8-IMPL-001`, `PHASE8-IMPL-002`, `PHASE8-IMPL-003`, `PHASE8-IMPL-004`, `PHASE8-IMPL-005`, and `PHASE8-IMPL-006` are complete as the first six published Writer Assistant Core parents in `docs/roadmap/roadmap_index.yaml`. `PHASE8-IMPL-007` is complete as the seventh Writer Assistant Core parent; `PHASE8-IMPL-007-T001` through `PHASE8-IMPL-007-T007` are complete. `PHASE8-IMPL-008` is complete as the eighth Writer Assistant Core parent; `PHASE8-IMPL-008-T001` through `PHASE8-IMPL-008-T007` are complete. `PHASE8-IMPL-008` delivered raw storage helpers and expected-red BookNLP fixture parser contract tests. `PHASE8-IMPL-009` is active as the ninth Writer Assistant Core parent; `PHASE8-IMPL-009-T001`, `PHASE8-IMPL-009-T002`, `PHASE8-IMPL-009-T003`, `PHASE8-IMPL-009-T004`, `PHASE8-IMPL-009-T005`, and `PHASE8-IMPL-009-T006` are complete, and `PHASE8-IMPL-009-T007` is active. T003 created the parser module and implemented the TSV parsers. T004 implemented `.book` JSON parsing and token-event derivation. T005 implemented raw artifact bundle builder integration. T006 validated the full parser contract and surrounding boundaries without needing parser code changes. T007 is roadmap/status closeout, and no real BookNLP/spaCy install or runtime extraction exists yet.
