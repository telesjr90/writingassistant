...
- Active child task: `PHASE8-IMPL-003-T006` - Candidate list/index helper implementation.
- Next child task: `PHASE8-IMPL-003-T007` - Roadmap/status closeout.
- Last completed child task: `PHASE8-IMPL-003-T005` - Candidate list/index contract tests.
...
- Next parent/child: `PHASE8-IMPL-003` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-003-T006`; next child is `PHASE8-IMPL-003-T007`.
