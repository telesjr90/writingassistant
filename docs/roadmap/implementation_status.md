...
- Active child task: `PHASE8-IMPL-002-T004` - Candidate record validation helpers.
- Next child task: `PHASE8-IMPL-002-T005` - Project-local candidate storage path contract tests.
- Last completed child under active parent: `PHASE8-IMPL-002-T003` - Candidate storage/evidence contract tests.
...
- Next parent/child: `PHASE8-IMPL-002` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-002-T004` after T003 contract tests.
