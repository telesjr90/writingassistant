...
- Immediate active parent task: pending publication of `PHASE8-IMPL-006` - Writer Assistant Core analysis-only candidate extraction architecture and spaCy-first local extraction foundation.
- Active child task: none published.
- Next child task: none under `PHASE8-IMPL-005`; next parent recommendation is `PHASE8-IMPL-006`.
