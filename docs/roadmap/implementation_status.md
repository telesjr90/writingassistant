...
- Active child task: `PHASE8-IMPL-004-T005` - Index safety and stale/corrupt regression tests.
- Next child task: `PHASE8-IMPL-004-T006` - Index safety repair or hardening.
- Last completed child task: `PHASE8-IMPL-004-T004` - Minimal candidate index helpers.
...
- Next child: `PHASE8-IMPL-004-T005` - Index safety and stale/corrupt regression tests under active parent `PHASE8-IMPL-004`.
