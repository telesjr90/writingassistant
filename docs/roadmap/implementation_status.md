...
- Active child task: `PHASE8-IMPL-004-T007` - Roadmap/status closeout.
- Next child task: none under active parent `PHASE8-IMPL-004` after T007 closeout.
- Last completed child task: `PHASE8-IMPL-004-T006` - Index safety repair or hardening (validation-only).
...
- Next child: `PHASE8-IMPL-004-T007` - Roadmap/status closeout under active parent `PHASE8-IMPL-004`.
