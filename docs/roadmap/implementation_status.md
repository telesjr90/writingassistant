...
- Active child task: `PHASE8-IMPL-006-T006` - BookNLP-ready adapter contract tests.
- Next child task: `PHASE8-IMPL-006-T007` - Roadmap/status closeout.
- Last completed child task: `PHASE8-IMPL-006-T005` - BookNLP-ready raw output and adapter contract decision.
