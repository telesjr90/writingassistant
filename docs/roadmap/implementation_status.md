...
- Active child task: `PHASE8-IMPL-003-T007` - Roadmap/status closeout.
- Next child task: none under this parent after T007 closeout.
- Last completed child task: `PHASE8-IMPL-003-T006` - Candidate list/index helper implementation.
...
- Next parent/child: `PHASE8-IMPL-003` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-003-T007`; next child is none under this parent after T007 closeout.
