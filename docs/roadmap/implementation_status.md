...
- Active child task: `PHASE8-IMPL-002-T003` - Candidate storage/evidence contract tests.
- Next child task: `PHASE8-IMPL-002-T004` - Candidate record validation helpers.
- Last completed child under active parent: `PHASE8-IMPL-002-T002` - Candidate storage and evidence/provenance contract decision.
...
- Next parent/child: `PHASE8-IMPL-002` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-002-T003` after T002 contract decision.
