...
- Active child task: `PHASE8-IMPL-006-T003` - Evidence/source-map contract tests.
- Next child task: `PHASE8-IMPL-006-T004` - Minimal source-map/evidence helper implementation.
- Last completed child task: `PHASE8-IMPL-006-T002` - Evidence/source-map contract decision.
