...
- Active child task: `PHASE8-IMPL-004-T006` - Index safety repair or hardening.
- Next child task: `PHASE8-IMPL-004-T007` - Roadmap/status closeout.
- Last completed child task: `PHASE8-IMPL-004-T005` - Index safety and stale/corrupt regression tests.
...
- Next child: `PHASE8-IMPL-004-T006` - Index safety repair or hardening (conditional docs/status validation only) under active parent `PHASE8-IMPL-004`.
