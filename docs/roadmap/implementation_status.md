...
- Active child task: `PHASE8-IMPL-004-T004` - Minimal candidate index helpers.
- Next child task: `PHASE8-IMPL-004-T005` - Index safety and stale/corrupt regression tests.
- Last completed child task: `PHASE8-IMPL-004-T003` - Candidate index contract tests.
...
- Next child: `PHASE8-IMPL-004-T004` - Minimal candidate index helpers under active parent `PHASE8-IMPL-004`.
