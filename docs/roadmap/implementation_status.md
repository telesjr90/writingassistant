...
- Active child task: `PHASE8-IMPL-005-T006` - NLP/extraction adapter strategy decision.
- Next child task: `PHASE8-IMPL-005-T007` - Roadmap/status closeout.
- Last completed child task: `PHASE8-IMPL-005-T005` - NCP/Subtxt structural interpretation strategy decision.
