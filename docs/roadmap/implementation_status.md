...
- Active child task: `PHASE8-IMPL-003-T005` - Candidate list/index contract tests.
- Next child task: `PHASE8-IMPL-003-T006` - Candidate list/index helper implementation.
- Last completed child task: `PHASE8-IMPL-003-T004` - Minimal candidate persistence helpers.
...
- Next parent/child: `PHASE8-IMPL-003` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-003-T005`; next child is `PHASE8-IMPL-003-T006`.
