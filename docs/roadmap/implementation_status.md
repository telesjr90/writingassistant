...
- Active child task: `PHASE8-IMPL-007-T003` - BookNLP adapter implementation decision after source inventory.
- Next child task: `PHASE8-IMPL-007-T004` - Manifest and raw artifact bundle validators.
- Last completed child task: `PHASE8-IMPL-007-T002` - Official repo retrieval/source inventory and implementation contract refresh.
