...
- Active child task: `PHASE8-IMPL-002-T005` - Project-local candidate storage path contract tests.
- Next child task: `PHASE8-IMPL-002-T006` - Candidate storage helper skeleton.
- Last completed child under active parent: `PHASE8-IMPL-002-T004` - Candidate record validation helpers.
...
- Next parent/child: `PHASE8-IMPL-002` is the active Writer Assistant Core parent; active child is `PHASE8-IMPL-002-T005` after T004 validation helpers.
