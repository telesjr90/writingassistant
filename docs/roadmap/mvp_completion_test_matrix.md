...
`WORKSPACE-012` defines OMI Ideas / Candidates page planning in `docs/roadmap/omi_ideas_candidates_page_spec.md`, including owner raw ideas, candidate review, owner decisions, destinations, evidence/provenance, promotion readiness, promotion audit records, local filters/search, warning states, API/UI surfaces, page relationships, and future page tests.
`WORKSPACE-013` defines Approved Characters page planning in `docs/roadmap/approved_characters_page_spec.md`, including applied `character_memory_record` display, evidence/provenance panel, linked sources panel, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-014` defines Approved Locations / Settings page planning in `docs/roadmap/approved_locations_settings_page_spec.md`, including applied `location_memory_record` display, evidence/provenance panel, linked sources panel, place hierarchy placeholder, scene usage snapshot, candidate backlog snapshot, warning states including parent/child cycle detection, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-015` defines Approved Timeline page planning in `docs/roadmap/approved_timeline_page_spec.md`, including applied `timeline_event_memory_record` display, evidence/provenance panel, linked sources panel, chronology/ordering placeholder, cause/effect placeholder, scene usage snapshot, candidate backlog snapshot, warning states including sequence collisions, chronology conflicts, and cause/effect cycles, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-016` defines Approved Plot Threads page planning in `docs/roadmap/approved_plot_threads_page_spec.md`, including applied `plot_thread_memory_record` display, evidence/provenance panel, linked sources panel, linked timeline/scene snapshot, related characters/locations/objects snapshot, related open-questions and continuity-warnings placeholders, candidate backlog snapshot, warning states including thread status conflicts, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-017` defines Continuity / Consistency page planning in `docs/roadmap/continuity_consistency_page_spec.md`, including applied continuity/consistency record display, evidence/provenance panel, linked sources panel, linked story-knowledge snapshot, resolution placeholder, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-018` defines Approved Open Questions page planning in `docs/roadmap/approved_open_questions_page_spec.md`, including applied open-question record display, evidence/provenance panel, linked sources panel, linked story-knowledge snapshot, owner-answer/resolution placeholder, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, and future page tests.
`WORKSPACE-019` defines Approved Relationships page planning in `docs/roadmap/approved_relationships_page_spec.md`, including applied relationship record display, participant snapshot, evidence/provenance panel, linked sources panel, linked story-knowledge snapshot, related plot/timeline/open-question/continuity snapshots, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, explicit non-Dramatica Relationship Story boundaries, and future page tests.
`WORKSPACE-020` defines Approved Organizations / Groups page planning in `docs/roadmap/approved_organizations_groups_page_spec.md`, including applied organization/group record display, members/leadership snapshot, hierarchy snapshot, evidence/provenance panel, linked sources panel, linked story-knowledge snapshot, related relationship/plot/timeline/open-question/continuity snapshots, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, explicit non-Dramatica structural-claim boundaries, and future page tests.
`WORKSPACE-021` defines Approved Objects / Items page planning in `docs/roadmap/approved_objects_items_page_spec.md`, including applied object/item record display, ownership/holder snapshot, location/movement snapshot, evidence/provenance panel, linked sources panel, linked story-knowledge snapshot, related plot/timeline/open-question/continuity snapshots, candidate backlog snapshot, warning states, API/UI surfaces, no-prose/no-silent-promotion boundaries, explicit non-Dramatica structural/thematic-claim boundaries, and future page tests.
