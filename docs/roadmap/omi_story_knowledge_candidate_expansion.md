...
- WORKSPACE-015 dedicated Approved Timeline page planning lives in `docs/roadmap/approved_timeline_page_spec.md` and defines the third approved-only category page: applied `timeline_event_memory_record` display, evidence/provenance panel, linked sources panel, chronology/ordering placeholder, cause/effect placeholder, scene usage snapshot, candidate backlog snapshot, warning states including sequence collisions, chronology conflicts, and cause/effect cycles, and no-prose/no-silent-promotion boundaries.
- WORKSPACE-016 dedicated Approved Plot Threads page planning lives in `docs/roadmap/approved_plot_threads_page_spec.md` and defines the fourth approved-only category page: applied `plot_thread_memory_record` display, evidence/provenance panel, linked sources panel, linked timeline/scene snapshot, related characters/locations/objects snapshot, related open-questions and continuity-warnings placeholders, candidate backlog snapshot, warning states including thread status conflicts, and no-prose/no-silent-promotion boundaries.
- WORKSPACE-017 dedicated Continuity / Consistency page planning lives in `docs/roadmap/continuity_consistency_page_spec.md` and defines the approved-only continuity/consistency page: applied continuity/consistency records, candidate separation, evidence/provenance, linked sources, linked story knowledge, resolution placeholders, warning states, and no-prose/no-silent-promotion boundaries.
- WORKSPACE-018 dedicated Approved Open Questions page planning lives in `docs/roadmap/approved_open_questions_page_spec.md` and defines the approved-only open-questions page: applied open-question records, candidate separation, evidence/provenance, linked sources, linked story knowledge, owner-answer/resolution placeholders, warning states, and no-prose/no-silent-promotion boundaries.
- WORKSPACE-019 dedicated Approved Relationships page planning lives in `docs/roadmap/approved_relationships_page_spec.md` and defines the approved-only relationships page: applied relationship records, candidate separation, participant snapshot, evidence/provenance, linked sources, linked story knowledge, related plot/timeline/open-question/continuity snapshots, warning states, no-prose/no-silent-promotion boundaries, and explicit non-Dramatica Relationship Story boundaries.
...
- WORKSPACE-024 dedicated Approved Scene / Event / Causality Review page planning lives in `docs/roadmap/approved_scene_event_causality_review_spec.md` and defines the approved-only scene/event/causality review page: approved scene-review, event/action, and causality-note records; candidate separation; source locator, cause/effect, evidence/provenance, linked source, linked approved-memory/story-knowledge, related timeline/plot/continuity/contradiction, and candidate backlog panels; warning states; no-prose/no-silent-promotion boundaries; and explicit non-Dramatica proof boundaries.
- WORKSPACE-025 dedicated Project Memory / Canon Cross-Linking and Health planning lives in `docs/roadmap/project_memory_canon_cross_linking_health_spec.md` and defines shared approved-memory record/link identity, future `memory/index.json` and category registry planning, category count snapshots, non-destructive health warnings, local health filtering, API/UI planning, and candidate/canon separation across approved memory, OMI candidates, promotion records, source documents, evidence, and provenance.
