...
9. Continue frontend hardening after FE-001 and App-4; rich Story Check UI sections and scene editor dirty-state handling are implemented, while broader save/load UX and context editing remain future work.
