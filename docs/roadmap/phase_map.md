...
owner-authored scene/chapter/note text
  ...
  -> BookNLP adapter contract implementation with mocked normalization after owner-approved PHASE8-IMPL-007 publication
