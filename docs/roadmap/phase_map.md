...
- Future sequence: `PHASE8-IMPL-020` is the recommended next MVP-required parent after review; `PHASE8-IMPL-020`, `PHASE8-IMPL-021`, and `PHASE8-IMPL-022` remain future MVP-required parents; fine-tuning remains deferred after MVP; generated prose/prose-production paths remain permanently forbidden.
