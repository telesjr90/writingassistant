...
- Latest completed phase-map item: `PHASE8-IMPL-023-T014C - Live spaCy adapter behind flags`.
...
- T014D result: `PHASE8-IMPL-023-T014D - Live spaCy manual validation` is complete/PASS-WITH-BLOCKED-RUNTIME. Decision record: `docs/roadmap/decisions/PHASE8-IMPL-023-T014D-manual-local-spacy-validation.md`. spaCy not installed in repo virtualenv; live adapter run not attempted. All fixture/mock contract tests pass.
- Next phase-map step: `PHASE8-IMPL-023-T014E - Live spaCy closeout` or `PHASE8-IMPL-023-T015 - Live Ollama integration` if spaCy remains unavailable.
