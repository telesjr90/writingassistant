...
- `PHASE8-IMPL-019-T003` is ready/active next for expected-red guarded runtime extraction contract tests only.
- `PHASE8-IMPL-019-T004` through `PHASE8-IMPL-019-T007` remain planned.
