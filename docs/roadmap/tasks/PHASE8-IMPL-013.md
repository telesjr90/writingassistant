...
6. `PHASE8-IMPL-013-T006` - Review API/UI safety regression or conditional hardening decision. Status: ready/active.
...
- `PHASE8-IMPL-013-T006` is ready/active.
- `PHASE8-IMPL-013-T007` is planned.
