...
- T006 — Safety regression: no silent promotion, no memory/canon mutation, no generated prose, no model/runtime/raw persistence. Ready/active next.
