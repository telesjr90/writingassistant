...
- T004 — Minimal backend command route/helper implementation for review-action execution only, no apply-promotion/canon mutation. Ready/active next.
