...
- T005 — Frontend owner-action workflow/surface implementation or planning path, depending on existing frontend harness/package constraints. Ready/active next.
