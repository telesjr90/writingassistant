...
- `PHASE8-IMPL-017-T003` - Tests-first expected-red apply-promotion contract. Ready/active next.
...
This parent does not authorize `PHASE8-IMPL-017-T001` or `PHASE8-IMPL-017-T002` to implement runtime behavior. T002 defines the apply-promotion boundary and audit model only; it does not implement apply-promotion, approved memory mutation, canon mutation, raw artifact persistence, runtime extraction, model-assisted extraction, real BookNLP/spaCy install/run/import, NCP/Subtxt/dramatica-flow runtime integration, generated prose, or training artifacts.
