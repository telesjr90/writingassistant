...
- `PHASE8-UX-002-T006` - Implement Notes/Materials + runtime/review evidence UI. Scope: split into focused slices. T006A Notes/Materials save-reload proof is complete/PASS for `UX2-NOTES-MATERIALS-001`; T006 remains in progress for raw artifact read-only/support-data UI evidence, safe review/apply-promotion fixture and confirmation evidence, and analysis-runtime label evidence. Status: in progress; T006B is next.
